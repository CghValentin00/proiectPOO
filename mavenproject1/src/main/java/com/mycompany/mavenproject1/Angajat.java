...
public class Angajat {
    ...
    void afisareDateAngajat()
    {
        ...
        System.out.println("\nSalariu: " + this.salariu + " Varsta: " + this.varsta + " Zile de concediu luate: " + this.zile_concediu_luate);
        System.out.println("\nZi anagaje: " + this.zi_angajare + " Luna angajare: " + this.luna_angajare + " An angajare: " + this.an_angajare);
    }
